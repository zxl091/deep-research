...
const chartIssues: Record<string, string> = { insufficient_data: '证据不足', table_parse_failed: '表格解析失败', render_failed: '绘图执行失败' }
...
export default function FullReportDetails({ run, section = 'all' }: { run: ResearchRun; section?: 'all' | 'chapters' | 'charts' | 'review' }) {
